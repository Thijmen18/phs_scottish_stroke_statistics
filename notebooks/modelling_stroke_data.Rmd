...
- Augmentation: find more data online about the smoking lvel under different 
...
necessarily seasonal and more importantly the data is on a yearly scale. That means I only have effectively
9 datapoints.
  - Plus I have future population predictions I want to use to predict strokes.
  
-> I can decide to continue with just creating a simple linear regression model.
Below code-chunks says that each predictor is significant (according to Jamie this 
