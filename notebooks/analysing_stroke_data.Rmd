...
#### Stroke mortality and incidences per health board
...
mortality_per_hb_wrap <- mortality_hb %>% 
  ...
  labs(
    x = "\nYear", 
    y = "Mortality per 100,000 population\n",
    title = "Cerebrovascular Disease Mortality per Healthboard",
    subtitle = "age and sex adjusted death rates per year")
...
incidences_per_hb_wrap <- activity_hb %>% 
  ...
  labs(
    x = "\nYear", 
    y = "Incidences per 100,000 population\n",
    title = "Cerebrovascular Disease Incidences per Healthboard",
    subtitle = "age and sex adjusted incidence rates per year")
...
Mortality change in easr - 2012 vs 2021:
```{r}
## sex
#Males
1-(766.8403/997.0874) # -0.23
#female
1-(714.8456/1033.6359) #-0.30
#all
1-(740.8429/1015.3616) #-0.27

## age-group
# 0-44 years
1-(3.050264/4.806742) #-0.36
# 45-64 years
1-(65.132479/63.033765) #+0.033
# 65-74 years
1-(273.975640/337.554489) #-0.18
# 75plus years
1-(1880.370360/2640.689870) #-0.28
```
...
Incidence change in easr - 2012 vs 2021:
```{r}
## sex
#Males
1-(12183.921/11296.164) #+ 0.07
#female
1-(9649.621/9108.495) #+ 0.05
#all
1-(10916.771/10202.330) # + 0.07

## age-group
# 0-44 years
1-(263.3454/231.2459) # +0.13
# 45-64 years
1-(3182.0960/2615.5838) # +0.21
# 65-74 years
1-(8235.0952/7534.1553) # +0.09
# 75plus years
1-(21069.7768	/20226.0038) # +0.04
```
